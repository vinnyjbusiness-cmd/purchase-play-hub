...
import { CalendarDays, TrendingUp, TrendingDown, X } from "lucide-react";
...
export default function OverviewTab({ events, orders, purchases, groupedIds }: Props) {
  ...
  const barChartData = periodGames.map(g => ({
    ...
    Revenue: g.revenue, Costs: g.costs, Profit: g.profit,
  }));
